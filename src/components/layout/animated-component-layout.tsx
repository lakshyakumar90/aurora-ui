...
import AnimatedPreviewCustomize from "@/components/layout/animated-component-layout.client";
import type { Control, ExampleConfig } from "@/components/layout/animated-component-types";

// types moved to shared file to avoid circular client/server problems
  ...
  return (
    <div className="max-w-5xl mx-auto pb-6 space-y-12">
      ...
      <section>
        ...
        <AnimatedPreviewCustomize example={example} controls={controls} />
      </section>
