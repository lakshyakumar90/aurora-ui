...
function Header() {
  ...
  return (
    <nav className="sticky top-0 z-[9999] border-b border-border bg-background px-6">
      <div className="mx-auto flex h-14 w-full items-center justify-between max-sm:px-2 md:max-w-7xl">
        ...
        <div className="flex items-center gap-x-4 px-1 flex-nowrap ">
          <Link href="/" className="whitespace-nowrap font-bold text-lg bg-gradient-to-r from-purple-400 via-pink-400 to-blue-400 bg-clip-text text-transparent">
            Aurora UI
          </Link>
