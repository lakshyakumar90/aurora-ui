...
export default function HeroSection() {
  return (
    <div className="relative min-h-[90vh] w-full flex flex-col justify-center items-center text-center gap-8 px-4 overflow-hidden">
        ...
        <div className="flex flex-col items-center gap-6 animate-fade-in-up">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-4">
            <Link href="/components">
              <button className="text-lg px-8 py-3 rounded-xl bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-300 flex items-center gap-2 group hover:scale-105 active:scale-95">
                Browse Components
            ...
            <Link href="/playground">
              <button className="text-lg px-8 py-3 rounded-xl border-2 border-purple-500/50 bg-transparent hover:bg-purple-500/10 text-foreground font-semibold transition-all duration-300 flex items-center gap-2 group hover:scale-105 active:scale-95">
                Try Playground
                <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform duration-300" />
              </button>
            </Link>
        ...
        <div className="flex flex-wrap justify-center gap-6 mt-8 animate-fade-in-up-delay">
