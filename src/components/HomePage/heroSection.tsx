  ...
  return (
      ...
      <div className="h-[75vh] w-full flex flex-col justify-center items-center text-center gap-7">
        ...
        <div className="flex gap-6">
          ...
          <Link rel="stylesheet" href="#">
            <button
              className="text-xl border-1 w-fit px-20 py-2 rounded-xl border-[#60A5FA] bg-blue-500   cursor-pointer
                            hover:bg-gradient-to-br from-[#A44BF8] to-blue-500 hover:scale-110 transition-transform duration-500
        ...
        <div className="flex gap-6 relative mt-5">
            <FaReact className="text-5xl text-gray-400 hover:scale-120 transition-transform ease-in-out " />
            <SiTypescript className="text-5xl  text-gray-400  hover:scale-120 transition-transform ease-in-out "  />
            <RiTailwindCssFill  className="text-5xl  text-gray-400  hover:scale-120 transition-transform ease-in-out "/>
            <TbBrandFramerMotion className="text-5xl  text-gray-400  hover:scale-120 transition-transform ease-in-out "/>
            <SiShadcnui className="text-5xl text-gray-400  hover:scale-120 transition-transform ease-in-out " />
